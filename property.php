...
<body>
    ...
    <p style = "color: darkgreen;text-align:center;font-size:large; font:arial;">If you want to add your properties with us</P>

    <button onclick="goToNextPage()"
    style="background-color:rgb(199, 48, 6); color: white; font-size: 20px; padding: 10px 20px; border: none; border-radius: 5px; display: block; margin: 20px auto; cursor: pointer">
    Add Properties
    </button>
       ...
       <script>
        function goToNextPage(){
          window.location.href = "propertyindex.php";
        }
        </script>
