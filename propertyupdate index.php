        ...
        * {box-sizing: border-box;}
        ...
        <form action="propertyupdate.php" method="post">        
            <div class="regcontain">
                <h1>Update Properties</h1><br>
                <p>Update from here.</p>
                <hr>
                ...
                <p style = "text-algin = 'center'">If you want to delete property press this button</P><br>.
                <button 
                   onclick="goToNextPage()" 
                   style="background-color: red; color: white; font-size: 15px; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
                   Delete Feedback
            </button>
          ...
          function goToNextPage() { 
            window.location.href = "property delindex.php"};
        </script>    
