...
<body>
    ...
    <form action="feedbackinsert.php" method="post">           
        <div class="regcontain">
            <h1>Delete your Feedback</h1><br>
            <p>Please Enter the mail and delete your feedback</p>   
            <hr>        
            ...
            <hr>
            <p>If you want to update your feedback <a href="#feedbackupdate index.php">Click Here</a>.</p><br>

            <button onclick="goToNextPage()" style=color: red>Delete Feedback</button>

    <script>
           // JavaScript function to move to another webpage
        function goToNextPage() {
            window.location.href = "#feedbackdelete index.php";    // Replace with your target URL
        }
    </script>
